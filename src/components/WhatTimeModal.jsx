...
const WhatTimeModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center overflow-hidden bg-black/50 px-3 pt-8 backdrop-blur-sm sm:items-center sm:p-4">
      <div
        className="mb-3 max-h-[calc(100vh-2.75rem)] w-full max-w-md rounded-t-[28px] rounded-b-none border-t border-transparent bg-transparent shadow-2xl dark:border-white/10 sm:mb-0 sm:max-h-[90vh] sm:rounded-[28px]"
        style={{
      ...
      >
        <div className="overflow-hidden rounded-t-[28px] rounded-b-none bg-white dark:bg-slate-950 sm:rounded-[28px]">
          <div
