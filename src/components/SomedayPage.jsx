                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{ position: 'absolute', bottom: 8, right: 8, width: 20, height: 20, borderRadius: '50%', background: 'rgba(255,255,255,0.85)', border: 'none', fontSize: 11, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.12)', zIndex: 10, color: '#9ca3af' }}
                          title="Write notes"
                        >✏️</button>
                      </div>
                      <div
        ...
        <div style={{ position: 'fixed', bottom: 'calc(88px + env(safe-area-inset-bottom))', right: 20, zIndex: 40, display: 'flex', alignItems: 'center', gap: 10 }}>
          {onAutoSortPins && (
            <button
              ...
              style={{ width: 42, height: 42, borderRadius: '50%', background: darkMode ? 'rgba(139,92,246,0.15)' : '#f5f3ff', border: `1px solid ${darkMode ? 'rgba(139,92,246,0.3)' : 'rgba(139,92,246,0.25)'}`, color: darkMode ? '#c4b5fd' : '#6d28d9', fontSize: 19, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, lineHeight: 1 }}
            >✦</button>
          )}
          {onAddPin && (
            <button
