...
function buildAutoSortedPins(pins, onAddDream, onDeleteDream, onUpdateDream, startY = 20) {
...
const SomedayPage = ({
  ...
  function autoSort() {
    ...
    setPins(prev => buildAutoSortedPins(prev, onAddDream, onDeleteDream, onUpdateDream, startY));
  }
